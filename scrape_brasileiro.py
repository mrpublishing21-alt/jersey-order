...
# Brazilian teams - Fortaleza has no dedicated page on jeogk9.com
teams = [
    "Flamengo",
    "Palmeiras", 
    "Atletico Mineiro",
    ...
    "Internacional",
    "Bragantino",
    # Fortaleza - no dedicated page, skip for now
    "Recife",
    "Botafogo",
    "Cruzeiro",
    "Bahia",
...
for team in teams:
    url = f'https://www.jeogk9.com/Search-{team}/list-r1.html'
...
# Save raw JSON
with open("C:/Users/lizmo/Desktop/jersey-order/brasileiro_raw.json", "w") as f:
    json.dump(all_jerseys, f, indent=2)

print(f"\nTotal Brasileiro jerseys scraped: {len(all_jerseys)}")
